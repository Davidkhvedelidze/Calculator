...
export default function HomePage() {
  return (
    <>
      <section className="gradient-sunrise">
        <div className="container grid gap-12 py-20 lg:grid-cols-[1.2fr,1fr] lg:items-center">
          <div className="space-y-10">
            ...
            <h1 className="max-w-2xl text-4xl font-display font-bold tracking-tight   sm:text-5xl">
              Unlock soulful adventures crafted by Must See Georgia.
            </h1>
            <p className="max-w-xl text-lg  ">
              We design immersive escapes across Georgia, pairing iconic
              landmarks with rare local encounters. Travel deeper with hosts who
              celebrate culture, cuisine, and community.
            </p>
            ...
            <dl className="grid gap-6 sm:grid-cols-3">
              {heroStats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-3xl border border-white/70 bg-white/80 p-5 text-center shadow-md"
                >
                  <dt className="text-sm font-medium  ">{stat.label}</dt>
                  <dd className="mt-2 text-2xl font-semibold text-brand-dark">
                    {stat.value}
                  </dd>
                </div>
              ))}
            ...
            <div className="card relative overflow-hidden rounded-[36px]">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900/80 to-transparent p-6 text-white">
                ...
                <p className="mt-3 text-sm text-white/80">
                  "Every itinerary felt like it was crafted exclusively for
                  us—intimate, surprising, and perfectly paced."
                </p>
                <p className="mt-2 text-xs uppercase tracking-widest text-brand-light">
                  — Zara & Mikel, Barcelona
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-base   dark:text-slate-300">
                Our curators unlock insider access to chefs, artisans, guides,
                and storytellers. We choreograph journeys that honor Georgian
                traditions while embracing modern comforts.
              </p>
            </div>
      ...
      <section className="bg-slate-50/70 dark:bg-slate-800/50">
        <div className="container space-y-10">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <span className="badge">Featured escapes</span>
              <h2 className="mt-4 text-3xl font-display font-semibold   dark:text-slate-100">
                Signature journeys to bookmark
              </h2>
            </div>
      ...
      <section className="bg-slate-50/70 dark:bg-slate-800/50">
        <div className="container grid gap-10 md:grid-cols-[1.2fr,1fr] lg:items-center">
          <div className="space-y-6">
            <span className="badge">Travel journal</span>
            <h2 className="text-3xl font-display font-semibold   dark:text-slate-100">
              Stories from our curators
            </h2>
            <p className="text-base   dark:text-slate-300">
              Stay inspired with dispatches from Georgia—from new hotel openings
              to seasonal tasting menus and mindful travel rituals.
            </p>
        ...
        <div className="container grid gap-10 lg:grid-cols-[1fr,1fr] lg:items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl font-display font-semibold text-white">
              Let’s choreograph your Georgian odyssey
            </h2>
            <p className="text-base text-white/80">
              Share your dream dates, travel style, and must-see moments. Our
              curators will respond within 24 hours with a handcrafted concept.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="btn-primary bg-white text-brand-dark hover:bg-brand-light"
              >
          ...
          <div className="card bg-white/10 text-white backdrop-blur">
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="btn-primary w-full bg-white text-brand-dark hover:bg-brand-light"
              >
                Submit request
              </button>
            </form>
